...
public enum MenusLocale implements IDataAccessor {
    ...
    LEADERBOARD_TYPES_KILLS_ENABLED_TITLE("LEADERBOARD.TYPES.KILLS.ENABLED.NAME", null, DataType.STRING,
            "&aKills Leaderboard"),
    LEADERBOARD_TYPES_KILLS_DISABLED_TITLE("LEADERBOARD.TYPES.KILLS.DISABLED.NAME", null, DataType.STRING,
            "&cKills Leaderboard"),
    ...
    LEADERBOARD_TYPES_WIN_STREAK_ENABLED_TITLE("LEADERBOARD.TYPES.WIN_STREAK.ENABLED.NAME", null, DataType.STRING,
            "&aBest Win Streaks Leaderboard"),
    LEADERBOARD_TYPES_WIN_STREAK_DISABLED_TITLE("LEADERBOARD.TYPES.WIN_STREAK.DISABLED.NAME", null, DataType.STRING,
    ...
    LEADERBOARD_TYPES_DEATHS_ENABLED_TITLE("LEADERBOARD.TYPES.DEATHS.ENABLED.NAME", null, DataType.STRING,
            "&aDeaths Leaderboard"),
    LEADERBOARD_TYPES_DEATHS_DISABLED_TITLE("LEADERBOARD.TYPES.DEATHS.DISABLED.NAME", null, DataType.STRING,
            "&cDeaths Leaderboard"),
    ...
    LEADERBOARD_TYPES_DEATHS_DISABLED_MATERIAL("LEADERBOARD.TYPES.DEATHS.DISABLED.MATERIAL", null, DataType.STRING,
            "GRAY_DYE"),
    PARTY_SETTINGS_TITLE("PARTY.SETTINGS.NAME", null, DataType.STRING, "&7Party Settings"),
    ...
    PARTY_SETTINGS_PRIVACY_TITLE("PARTY.SETTINGS.PRIVACY.NAME", null, DataType.STRING, "&bPublic Party"),
    ...
    PARTY_SETTINGS_PRIVACY_DISABLED_LORE("PARTY.SETTINGS.PRIVACY.DISABLED-LORE", null, DataType.STRING_LIST,
            ...
            " ",
            "&aClick to enable."),
    PARTY_SETTINGS_MAX_SIZE_TITLE("PARTY.SETTINGS.MAX_SIZE.NAME", null, DataType.STRING, "&bPlayer Limit"),
    ...
    PARTY_EVENTS_TITLE("PARTY.EVENTS.NAME", null, DataType.STRING, "&7Party Events"),
    ...
    PARTY_EVENTS_SPLIT_TITLE("PARTY.EVENTS.SPLIT.NAME", null, DataType.STRING, "&bParty Split"),
    ...
    PARTY_EVENTS_FFA_TITLE("PARTY.EVENTS.FFA.TITLE", null, DataType.STRING, "&bParty FFA"),
    PARTY_EVENTS_FFA_LORE("PARTY.EVENTS.FFA.LORE", null, DataType.STRING_LIST,
            "&7Players fight each other",
            "&7till one is standing.",
            " ",
            "&a&lClick to start event!"),
    PARTY_EVENTS_KIT_SELECT_TITLE("PARTY.EVENTS.KIT.SELECT.TITLE", null, DataType.STRING, "&bKit Select"),
    ...
    DIVISIONS_LORE("DIVISIONS.LORE", null, DataType.STRING_LIST,
            "&7To reach this this rank you", "&7need <wins> wins."),
    SETTINGS_TITLE("SETTINGS.TITLE", null, DataType.STRING, "&7Profile Settings"),
    SETTINGS_SIZE("SETTINGS.SIZE", null, DataType.INT, "36"),
    SETTINGS_FILTER("SETTINGS.FILTER-TYPE", "FILL, BORDER, NONE", DataType.STRING, "FILL"),

    SETTINGS_PLAYER_VISIBILITY_MATERIAL("SETTINGS.PLAYER-VISIBILITY.MATERIAL", null, DataType.STRING, "ENDER_EYE"),
    SETTINGS_PLAYER_VISIBILITY_TITLE("SETTINGS.PLAYER-VISIBILITY.NAME", null, DataType.STRING, "&bPlayer Visibility"),
    SETTINGS_PLAYER_VISIBILITY_LORE_ENABLED("SETTINGS.PLAYER-VISIBILITY.LORE_ENABLED", null, DataType.STRING_LIST,
            ...
            " ",
            "&cClick to disable."),
    SETTINGS_PLAYER_VISIBILITY_LORE_DISABLED("SETTINGS.PLAYER-VISIBILITY.LORE_DISABLED", null, DataType.STRING_LIST,
            "&7Toggle Player Visibility",
            "&7in spawn.",
            "",
            " &7&l▶ &7Enabled",
            ...
            " ",
            "&aClick to enable."),
    SETTINGS_PLAYER_VISIBILITY_SLOT("SETTINGS.PLAYER-VISIBILITY.SLOT", null, DataType.INT, "10"),
    SETTINGS_ALLOW_SPECTATORS_MATERIAL("SETTINGS.ALLOW-SPECTATORS.MATERIAL", null, DataType.STRING, "EGG"),
    SETTINGS_ALLOW_SPECTATORS_TITLE("SETTINGS.ALLOW-SPECTATORS.NAME", null, DataType.STRING, "&bAllow Spectators"),
    SETTINGS_ALLOW_SPECTATORS_LORE_ENABLED("SETTINGS.ALLOW-SPECTATORS.LORE_ENABLED", null, DataType.STRING_LIST,
            ...
            " ",
            "&cClick to disable."),
    SETTINGS_ALLOW_SPECTATORS_LORE_DISABLED("SETTINGS.ALLOW-SPECTATORS.LORE_DISABLED", null, DataType.STRING_LIST,
            "&7Allow Spectators to",
            "&7spectate your match.",
            "",
            " &7&l▶ &7Enabled",
            ...
            " ",
            "&aClick to enable."),
    SETTINGS_ALLOW_SPECTATORS_SLOT("SETTINGS.ALLOW-SPECTATORS.SLOT", null, DataType.INT, "11"),
    SETTINGS_ALLOW_DUEL_REQUESTS_MATERIAL("SETTINGS.ALLOW-DUEL-REQUESTS.MATERIAL", null, DataType.STRING, "DIAMOND_SWORD"),
    SETTINGS_ALLOW_DUEL_REQUESTS_TITLE("SETTINGS.ALLOW-DUEL-REQUESTS.NAME", null, DataType.STRING, "&bAllow Duel requests"),
    SETTINGS_ALLOW_DUEL_REQUESTS_LORE_ENABLED("SETTINGS.ALLOW-DUEL-REQUESTS.LORE_ENABLED", null, DataType.STRING_LIST,
            "&7Allow players to",
            ...
            " ",
            "&cClick to disable."),
    SETTINGS_ALLOW_DUEL_REQUESTS_LORE_DISABLED("SETTINGS.ALLOW-DUEL-REQUESTS.LORE_DISABLED", null, DataType.STRING_LIST,
            "&7Allow players to",
            "&7send you duel requests.",
            "",
            " &7&l▶ &7Enabled",
            ...
            " ",
            "&aClick to enable."),
    SETTINGS_ALLOW_DUEL_REQUESTS_SLOT("SETTINGS.ALLOW-DUEL-REQUESTS.SLOT", null, DataType.INT, "12"),
    SETTINGS_ALLOW_PARTY_REQUESTS_MATERIAL("SETTINGS.ALLOW-PARTY-REQUESTS.MATERIAL", null, DataType.STRING, "STICK"),
    SETTINGS_ALLOW_PARTY_REQUESTS_TITLE("SETTINGS.ALLOW-PARTY-REQUESTS.NAME", null, DataType.STRING, "&bAllow Party requests"),
    SETTINGS_ALLOW_PARTY_REQUESTS_LORE_ENABLED("SETTINGS.ALLOW-PARTY-REQUESTS.LORE_ENABLED", null, DataType.STRING_LIST,
            "&7Allow players to",
            ...
            " ",
            "&cClick to disable."),
    SETTINGS_ALLOW_PARTY_REQUESTS_LORE_DISABLED("SETTINGS.ALLOW-PARTY-REQUESTS.LORE_DISABLED", null, DataType.STRING_LIST,
            "&7Allow players to",
            "&7send you party requests.",
            "",
            " &7&l▶ &7Enabled",
            ...
            " ",
            "&aClick to enable."),
    SETTINGS_ALLOW_PARTY_REQUESTS_SLOT("SETTINGS.ALLOW-PARTY-REQUESTS.SLOT", null, DataType.INT, "13");
