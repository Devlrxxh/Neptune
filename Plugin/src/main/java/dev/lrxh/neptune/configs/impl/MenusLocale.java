...
public enum MenusLocale implements IDataAccessor {
    ...
    PARTY_SETTINGS_PRIVACY_TITLE("PARTY.SETTINGS.PRIVACY.TITLE", null, DataType.STRING, "&bPublic Party"),
    ...
    PARTY_SETTINGS_PRIVACY_DISABLED_LORE("PARTY.SETTINGS.PRIVACY.DISABLED-LORE", null, DataType.STRING_LIST,
            ...
            " ",
            "&aClick to enable."),
    PARTY_SETTINGS_MAX_SIZE_TITLE("PARTY.SETTINGS.MAX_SIZE.TITLE", null, DataType.STRING, "&bPlayer Limit"),
    ...
    PARTY_EVENTS_SPLIT_TITLE("PARTY.EVENTS.SPLIT.TITLE", null, DataType.STRING, "&bParty Split"),
    ...
    SETTINGS_PLAYER_VISIBILITY_TITLE("SETTINGS.PLAYER-VISIBILITY.TITLE", null, DataType.STRING, "&bPlayer Visibility"),
    ...
    SETTINGS_ALLOW_SPECTATORS_TITLE("SETTINGS.ALLOW-SPECTATORS.TITLE", null, DataType.STRING, "&bAllow Spectators"),
    ...
    SETTINGS_ALLOW_DUEL_REQUESTS_TITLE("SETTINGS.ALLOW-DUEL-REQUESTS.TITLE", null, DataType.STRING, "&bAllow Duels"),
    ...
    SETTINGS_ALLOW_PARTY_REQUESTS_TITLE("SETTINGS.ALLOW-PARTY-REQUESTS.TITLE", null, DataType.STRING, "&bAllow Party requests"),
