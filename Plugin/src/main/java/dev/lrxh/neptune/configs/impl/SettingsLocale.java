...
public enum SettingsLocale implements IDataAccessor {
    ...
    ARENA_COPY_OFFSET_X("ARENA.COPY_OFFSET.X", "The offset in the X direction when duplicating a arena.", DataType.INT, "496"),
    ARENA_COPY_OFFSET_Z("ARENA.COPY_OFFSET.Z", "The offset in the Z direction when duplicatingw a arena.", DataType.INT, "0"),
