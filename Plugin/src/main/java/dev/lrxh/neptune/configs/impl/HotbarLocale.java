...
public enum HotbarLocale implements IDataAccessor {
    ...
    LOBBY_PLAY_AGAIN_NAME("ITEMS.IN_LOBBY.PLAY_AGAIN.NAME", DataType.STRING, "&79lay <kit> again &7(Right Click)"),
    LOBBY_PLAY_AGAIN_MATERIAL("ITEMS.IN_LOBBY.PLAY_AGAIN.MATERIAL", DataType.STRING, "PAPER"),
    LOBBY_PLAY_AGAIN_SLOT("ITEMS.IN_LOBBY.PLAY_AGAIN.SLOT", DataType.INT, "3"),
    LOBBY_PLAY_AGAIN_ENABLED("ITEMS.IN_LOBBY.PLAY_AGAIN.ENABLED", DataType.BOOLEAN, "true"),
