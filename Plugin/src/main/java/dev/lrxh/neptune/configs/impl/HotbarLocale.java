...
public enum HotbarLocale implements IDataAccessor {
    ...
    LOBBY_UNRANKED_LORE("ITEMS.IN_LOBBY.UNRANKED.LORE", DataType.STRING_LIST, "&7Queue for a random match"),
    ...
    LOBBY_SPECTATE_MENU_LORE("ITEMS.IN_LOBBY.SPECTATE_MENU.LORE", DataType.STRING_LIST, "&7View all ongoing matches"),
    ...
    LOBBY_LEADERBOARDS_LORE("ITEMS.IN_LOBBY.LEADERBOARDS.LORE", DataType.STRING_LIST, "&7View all leaderboards"),
    ...
    LOBBY_KIT_EDITOR_LORE("ITEMS.IN_LOBBY.KIT_EDITOR.LORE", DataType.STRING_LIST, "&7Edit all kits"),
    ...
    IN_GAME_PLAY_AGAIN_LORE("ITEMS.IN_GAME.PLAY_AGAIN.LORE", DataType.STRING_LIST, "&7Play again with the same opponent"),
    ...
    LOBBY_PARTY_CREATE_LORE("ITEMS.IN_LOBBY.PARTY_CREATE.LORE", DataType.STRING_LIST, "&7Create a party"),
    ...
    LOBBY_SETTINGS_LORE("ITEMS.IN_LOBBY.SETTINGS.LORE", DataType.STRING_LIST, "&7Open settings menu"),
    ...
    LOBBY_STATS_LORE("ITEMS.IN_LOBBY.STATS.LORE", DataType.STRING_LIST, "&7View your stats"),
    ...
    LOBBY_DIVISIONS_LORE("ITEMS.IN_LOBBY.DIVISIONS.LORE", DataType.STRING_LIST, "&7View all divisions"),
    ...
    IN_QUEUE_QUEUE_LEAVE_LORE("ITEMS.IN_QUEUE.QUEUE_LEAVE.LORE", DataType.STRING_LIST, "&7Leave the queue"),
    ...
    IN_QUEUE_LEADERBOARDS_LORE("ITEMS.IN_QUEUE.LEADERBOARDS.LORE", DataType.STRING_LIST, "&7View all leaderboards"),
    ...
    IN_QUEUE_STATS_LORE("ITEMS.IN_QUEUE.STATS.LORE", DataType.STRING_LIST, "&7View your stats"),
    ...
    IN_PARTY_PARTY_INFO_LORE("ITEMS.IN_PARTY.PARTY_INFO.LORE", DataType.STRING_LIST, "&7View party information"),
    ...
    IN_PARTY_PARTY_SETTINGS_LORE("ITEMS.IN_PARTY.PARTY_SETTINGS.LORE", DataType.STRING_LIST, "&7Edit party settings"),
    ...
    IN_PARTY_PARTY_EVENTS_LORE("ITEMS.IN_PARTY.PARTY_EVENTS.LORE", DataType.STRING_LIST, "&7View party events"),
    ...
    IN_PARTY_PARTY_DISBAND_LORE("ITEMS.IN_PARTY.PARTY_DISBAND.LORE", DataType.STRING_LIST, "&7Leave the party"),
