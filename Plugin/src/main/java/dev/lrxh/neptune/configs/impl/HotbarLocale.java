...
public enum HotbarLocale implements IDataAccessor {
    ...
    LOBBY_DIVISIONS_NAME("ITEMS.IN_LOBBY.DIVISIONS.NAME", null, DataType.STRING, "&eView Divisions &7(Right Click)"),
    LOBBY_DIVISIONS_MATERIAL("ITEMS.IN_LOBBY.DIVISIONS.MATERIAL", null, DataType.STRING, "EMERALD"),
    LOBBY_DIVISIONS_SLOT("ITEMS.IN_LOBBY.DIVISIONS.SLOT", null, DataType.INT, "6"),
    LOBBY_DIVISIONS_ENABLED("ITEMS.IN_LOBBY.DIVISIONS.ENABLED", null, DataType.BOOLEAN, "true"),
