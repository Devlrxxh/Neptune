...
public enum HotbarLocale implements IDataAccessor {
    ...
    IN_SPECTATOR_SPECTATOR_TELEPORT_NAME("ITEMS.IN_SPECTATOR.SPECTATOR_TELEPORT.NAME", DataType.STRING, "&eTeleport to player &7(Right Click)"),
    IN_SPECTATOR_SPECTATOR_TELEPORT_MATERIAL("ITEMS.IN_SPECTATOR.SPECTATOR_TELEPORT.MATERIAL", DataType.STRING, "COMPASS"),
    IN_SPECTATOR_SPECTATOR_TELEPORT_SLOT("ITEMS.IN_SPECTATOR.SPECTATOR_TELEPORT.SLOT", DataType.INT, "4"),
    IN_SPECTATOR_SPECTATOR_TELEPORT_LORE("ITEMS.IN_SPECTATOR.SPECTATOR_TELEPORT.LORE", DataType.STRING_LIST, " ", "&aClick to teleport to a player"),
    IN_SPECTATOR_SPECTATOR_TELEPORT_ENABLED("ITEMS.IN_SPECTATOR.SPECTATOR_TELEPORT.ENABLED", DataType.BOOLEAN, "false"),
    IN_SPECTATOR_SPECTATOR_LEAVE_NAME("ITEMS.IN_SPECTATOR.SPECTATOR_LEAVE.NAME", DataType.STRING, "&cLeave &7(Right click)"),
    IN_SPECTATOR_SPECTATOR_LEAVE_MATERIAL("ITEMS.IN_SPECTATOR.SPECTATOR_LEAVE.MATERIAL", DataType.STRING, "REDSTONE"),
    IN_SPECTATOR_SPECTATOR_LEAVE_SLOT("ITEMS.IN_SPECTATOR.SPECTATOR_LEAVE.SLOT", DataType.INT, "8"),
    IN_SPECTATOR_SPECTATOR_LEAVE_LORE("ITEMS.IN_SPECTATOR.SPECTATOR_LEAVE.LORE", DataType.STRING_LIST, " ", "&aClick to exit spectator mode"),
    IN_SPECTATOR_SPECTATOR_LEAVE_ENABLED("ITEMS.IN_SPECTATOR.SPECTATOR_LEAVE.ENABLED", DataType.BOOLEAN, "true");
