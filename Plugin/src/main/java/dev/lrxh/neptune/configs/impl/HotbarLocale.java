...
public enum HotbarLocale implements IDataAccessor {
    ...
    LOBBY_SPECTATE_MENU_ENABLED("ITEMS.IN_LOBBY.SPECTATE_MENU.ENABLED", null, DataType.BOOLEAN, "false"),
    ...
    LOBBY_LEADERBOARDS_SLOT("ITEMS.IN_LOBBY.LEADERBOARDS.SLOT", null, DataType.INT, "1"),
    LOBBY_LEADERBOARDS_ENABLED("ITEMS.IN_LOBBY.LEADERBOARDS.ENABLED", null, DataType.BOOLEAN, "true"),
    LOBBY_KIT_EDITOR_NAME("ITEMS.IN_LOBBY.KIT_EDITOR.NAME", null, DataType.STRING, "&3Kit Editor &7(Right Click)"),
    LOBBY_KIT_EDITOR_MATERIAL("ITEMS.IN_LOBBY.KIT_EDITOR.MATERIAL", null, DataType.STRING, "BOOK"),
    LOBBY_KIT_EDITOR_SLOT("ITEMS.IN_LOBBY.KIT_EDITOR.SLOT", null, DataType.INT, "2"),
    ...
    LOBBY_PARTY_CREATE_SLOT("ITEMS.IN_LOBBY.PARTY_CREATE.SLOT", null, DataType.INT, "4"),
    LOBBY_PARTY_CREATE_ENABLED("ITEMS.IN_LOBBY.PARTY_CREATE.ENABLED", null, DataType.BOOLEAN, "true"),
    LOBBY_SETTINGS_NAME("ITEMS.IN_LOBBY.SETTINGS.NAME", null, DataType.STRING, "&dSettings &7(Right Click)"),
    LOBBY_SETTINGS_MATERIAL("ITEMS.IN_LOBBY.SETTINGS.MATERIAL", null, DataType.STRING, "COMPASS"),
    LOBBY_SETTINGS_SLOT("ITEMS.IN_LOBBY.SETTINGS.SLOT", null, DataType.INT, "7"),
    LOBBY_SETTINGS_ENABLED("ITEMS.IN_LOBBY.SETTINGS.ENABLED", null, DataType.BOOLEAN, "true"),
    LOBBY_STATS_NAME("ITEMS.IN_LOBBY.STATS.NAME", null, DataType.STRING, "&eYour Stats &7(Right Click)"),
    LOBBY_STATS_MATERIAL("ITEMS.IN_LOBBY.STATS.MATERIAL", null, DataType.STRING, "PLAYER_HEAD"),
    LOBBY_STATS_SLOT("ITEMS.IN_LOBBY.STATS.SLOT", null, DataType.INT, "8"),
    ...
    IN_QUEUE_LEADERBOARDS_NAME("ITEMS.IN_QUEUE.LEADERBOARDS.NAME", null, DataType.STRING, "&9Leaderboards &7(Right Click)"),
    IN_QUEUE_LEADERBOARDS_MATERIAL("ITEMS.IN_QUEUE.LEADERBOARDS.MATERIAL", null, DataType.STRING, "NETHER_STAR"),
    IN_QUEUE_LEADERBOARDS_SLOT("ITEMS.IN_QUEUE.LEADERBOARDS.SLOT", null, DataType.INT, "4"),
    IN_QUEUE_LEADERBOARDS_ENABLED("ITEMS.IN_QUEUE.LEADERBOARDS.ENABLED", null, DataType.BOOLEAN, "true"),
    IN_QUEUE_STATS_NAME("ITEMS.IN_QUEUE.STATS.NAME", null, DataType.STRING, "&eYour Stats &7(Right Click)"),
    IN_QUEUE_STATS_MATERIAL("ITEMS.IN_QUEUE.STATS.MATERIAL", null, DataType.STRING, "PLAYER_HEAD"),
    IN_QUEUE_STATS_SLOT("ITEMS.IN_QUEUE.STATS.SLOT", null, DataType.INT, "0"),
    IN_QUEUE_STATS_ENABLED("ITEMS.IN_QUEUE.STATS.ENABLED", null, DataType.BOOLEAN, "true"),
