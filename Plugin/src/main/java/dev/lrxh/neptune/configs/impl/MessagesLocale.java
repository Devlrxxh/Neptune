...
public enum MessagesLocale implements IDataAccessor {
    ...
    PARTY_ADVERTISE_ENABLED("PARTY.ADVERTISE.ENABLED", DataType.STRING_LIST, "&bYour party will now be automatically advertised to the public."),
    PARTY_ADVERTISE_DISABLED("PARTY.ADVERTISE.DISABLED", DataType.STRING_LIST, "&bStopped automatically advertising your party."),
