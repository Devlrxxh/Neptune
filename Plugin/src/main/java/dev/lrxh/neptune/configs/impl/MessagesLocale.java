...
public enum MessagesLocale implements IDataAccessor {
    ...
    SPECTATE_NOT_ALLOWED("MATCH.SPECTATE.SPECTATE_NOT_ALLOWED", null, DataType.STRING_LIST, "&c<player> has spectating disabled."),
    ...
    PARTY_DISABLED("PARTY.DISABLED", null, DataType.STRING_LIST, "&c<player> has party requests disabled!"),
