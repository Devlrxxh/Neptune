...
public enum MessagesLocale implements IDataAccessor {
    ...
    QUEUE_JOIN("QUEUE.JOIN", null, DataType.STRING_LIST, "&aYou are now queued for <type> <kit>"),
    QUEUE_LEAVE("QUEUE.LEAVE", null, DataType.STRING_LIST, "&cYou have been removed from queue."),
